...
public class ModelAdepter_service extends FirebaseRecyclerAdapter<MainModel,ModelAdepter_service.ViewHolder> {
    ...
    @NonNull
    @Override
    public ModelAdepter_service.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
